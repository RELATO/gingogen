...
import (
	"github.com/relato/gingogen/parser"
...
var modelCmd = &cobra.Command{
	...
	Example: `gingogen model -u root -p password -a 127.0.0.1:3306 -d venom -c utf8  -o=github.com/relato/gingogen/out_model`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		log.Println("demo https://github.com/relato/gingogen/blob/master/boilerplate/config/viper.go")
	},
}
